...
def search(request):
    try:
        ...
        actions = models.ActionLibrary.objects.filter(**conditions)[start:end].values('id', 'name', 'info', 'level__level', 'machine__name','muscle__name', 'picture__url')
...
def getactionbyid(request):
    try:
        ...
        if not action_picture:
            action_picture=[{'url':'https://w2.dwstatic.com/yy/ojiastoreimage/6f3id6380e9c3478913497538d77846575.jpg'}]
